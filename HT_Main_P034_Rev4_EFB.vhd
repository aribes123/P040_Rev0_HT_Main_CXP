...
-- Module  Version: 1.2
--C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n HT_Main_P034_Rev4_EFB -lang vhdl -synth lse -bus_exp 7 -bb -type efb -arch xo2c00 -freq 25 -i2c1 -i2c1_freq 100 -i2c1_sa 0001001 -i2c1_addr 7 -wb -dev 2000 

-- Wed Apr 22 09:02:22 2020
...
entity HT_Main_P034_Rev4_EFB is
    port (
...
end HT_Main_P034_Rev4_EFB;

architecture Structure of HT_Main_P034_Rev4_EFB is
...
begin
    ...
    EFBInst_0: EFB
        ...
        I2C1_GEN_CALL=> "DISABLED", I2C1_CLK_DIVIDER=>  63, 
        I2C1_BUS_PERF=> "100kHz", I2C1_SLAVE_ADDR=> "0b0001001", 
        I2C1_ADDRESSING=> "7BIT", EFB_I2C1=> "ENABLED", EFB_WB_CLK_FREQ=> "25.0")
